            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div class="mt-5">
                    <div class="input-group flex-nowrap" style="box-shadow: 23px 23px 13px 1px rgba(0, 0, 0, 0.2);">
                        ...
                        <input type="password" class="form-control" id="password" name="password" style="font-size:20px;" placeholder="password"
                ...
                <div class="mt-5">
                    <div class="input-group flex-nowrap" style="box-shadow: 23px 23px 13px 1px rgba(0, 0, 0, 0.2);">
                        ...
                        <input type="password" class="form-control" style="font-size:20px;"
                            placeholder="Confirm password" id="passwordConfirm" name="passwordConfirm" aria-describedby="addon-wrapping">
                    </div>
                </div>
        ...
        <div class="d-flex flex-column justify-content-center align-items-center" style="width: 100%; height: 100%;">
            ...
            <div class="mt-5">
                <div class="mt-5 text-center" style="font-size:25px;">
                    <span class="text-white">Ya tienes cuenta?</span> <a href="{{route('login')}}"class="text-white">Inicia
                        sesion</a>
                </div>
            </div>
        </div>
