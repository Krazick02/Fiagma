...
<body>
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 navbar-nav-right">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  ...
                  </svg>  Jesus Emmanuel</a>
                <ul class="dropdown-menu dropdown-menu-white">
                    <li><a class="btn dropdown-item" href="{{route('logout')}}" style="color: #FF4F5B;">Cerrar Sesión</a></li>
                </ul>
            </li>
        </ul>
      </div>
  ...
  <div class="d-flex flex-row ">
    <div class="rectangle-left d-flex align-items-center justify-content-center bg-dark">
      <a href="main.html" class="btn text-white text-center" style="background-color: #FF4F5B; width: 200px; height:40px;">
        Nuevo diseño
    ...
    <div class="d-flex flex-column align-items-center justify-content-center" style="width: 100%; height: 100%;">
      <div >
        <img src="src/img/uxui.jpg" class="img-responsive" style="width: 629px; height: 340px;box-shadow: 0px 23px 23px rgba(0, 0, 0, 0.22);
